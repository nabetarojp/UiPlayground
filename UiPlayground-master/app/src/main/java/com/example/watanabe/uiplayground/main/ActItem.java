...
import com.example.watanabe.uiplayground.enteranimation.EnterAnimationActivity;
...
public enum ActItem {
    ...
    ENTER_ANIMATION("enter animation", "https://proandroiddev.com/enter-animation-using-recyclerview-and-layoutanimation-part-1-list-75a874a5d213", "", EnterAnimationActivity.class),
    ;
    final String label;
    final String url;
    final String imgUrl;
